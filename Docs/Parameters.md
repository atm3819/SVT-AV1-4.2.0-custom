...
| **HdrChromaDeltaQ**              | --hdr-chroma-deltaq              | [0-1]      | 0           | Derive per-frame chroma delta Q from ITU-T H.Sup15 section 8.3.2 for HDR content; requires PQ (transfer-characteristics 16) and 10-bit input, overrides the static chroma qindex offsets |
